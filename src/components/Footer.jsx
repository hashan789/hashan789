...
import footer from '../images/footer_image.png';

const Footer = () => (
  <footer className="py-6 text-white text-center max-sm:bg-center max-sm:bg-cover" style={{ backgroundImage : `url(${footer})` }}>
